...
import static com.emirhanarici.order_service.testdata.TestDataFactory.*;
...
import com.emirhanarici.order_service.domain.OrderService;
import com.emirhanarici.order_service.domain.SecurityService;
...
class OrderControllerUnitTests {
    ...
    @BeforeEach
    void setUp() {
        given(securityService.getLoginUserName()).willReturn("emirhan");
    }
    ...
    void shouldReturnBadRequestWhenOrderPayloadIsInvalid(CreateOrderRequest request) throws Exception {
        given(orderService.createOrder(eq("emirhan"), any(CreateOrderRequest.class)))
                .willReturn(null);
